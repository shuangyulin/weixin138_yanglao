  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(225, 225, 225, 1);borderRadius:26px">
        <h1 class="h1" style="color:rgba(0, 0, 0, 1);fontSize:28px;">社区互助养老小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='zhiyuanzhe'" class="input-group">
			   <div class="label">志愿号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhiyuanhao" class="input" type="text" placeholder="志愿号">
			   </div>
			 </div> -->
			<el-form-item label="志愿号" class="input" v-if="tableName=='zhiyuanzhe'">
			  <el-input v-model="ruleForm.zhiyuanhao" autocomplete="off" placeholder="志愿号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhiyuanzhe'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
