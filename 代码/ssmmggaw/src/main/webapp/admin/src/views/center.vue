  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhiyuanzhe'"  label="志愿号" prop="zhiyuanhao">
          <el-input v-model="ruleForm.zhiyuanhao" readonly              placeholder="志愿号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.zhiyuanhao)&& 'zhiyuanzhe'==this.flag){
