<template>
	<view class="content">
		...
		<view v-if="tableName=='zhiyuanzhe'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"40rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.zhiyuanhao" type="text" class="uni-input" name="" placeholder="志愿号" />
		</view>
		<view v-if="tableName=='zhiyuanzhe'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"40rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.mima" type="text" class="uni-input" name="" placeholder="密码" />
		</view>
	...
	export default {
		...
		async onLoad() {
			...
			if(this.tableName=='zhiyuanzhe'){
				...
				this.ruleForm.xingbie=this.zhiyuanzhexingbieOptions[0]
			}
